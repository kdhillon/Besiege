...
public class VictoryManager {
    ...
    // Per-party rewards
    public HashMap<Party, Integer> fameRewards = new HashMap<Party, Integer>();
    public HashMap<Party, Integer> moraleRewards = new HashMap<Party, Integer>();
    public HashMap<Party, Integer> expRewards = new HashMap<Party, Integer>();
    public HashMap<Party, Integer> wealthRewards = new HashMap<Party, Integer>();
...
//    public HashMap<Party, Integer> troopsWounded = new HashMap<>();
    ...
    private HashMap<Party, StrictArray<Soldier>> woundedMap = new HashMap<Party, StrictArray<Soldier>>();
    private HashMap<Party, StrictArray<Soldier>> killedMap = new HashMap<Party, StrictArray<Soldier>>();

    private HashMap<Party, StrictArray<Soldier>> prisonersToReceive = new HashMap<Party, StrictArray<Soldier>>();
...
//            addTo(troopsWounded, soldier.party, 1);
    ...
    public StrictArray<Soldier> getKilledSoldiersIn(Party p) {
        ...
        else return new StrictArray<Soldier>();
    }
