...
//	int currentTeam;
	...
	public SiegeUnit(BattleStage parent, SiegeType type, int pos_x, int pos_y, Orientation orientation) {
		...
		animationFiring.setPlayMode(Animation.PlayMode.NORMAL);
...
//				// try the last two directions as a last resort
	...
	public void drawAnimation(Batch batch, Animation<TextureRegion> animation, float stateTime, boolean loop) {
