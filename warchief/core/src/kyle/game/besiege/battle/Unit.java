...
//	public boolean canRetreat = true;
	...
	private static class ThrownItem extends Actor {
        public Animation<TextureRegion> sling;
        ...
        public ThrownItem(RangedWeaponType.Type type) {
            ...
            if (type == RangedWeaponType.Type.SLING) {
                ...
                sling.setPlayMode(Animation.PlayMode.LOOP);
	    ...
	    public void draw(Batch batch, float parentAlpha) {
            ...
            if (parent.unitDraw.isDrawingRangedLoadedAnimation()) {
                UnitDraw.drawAnimationTint(batch, sling, parent.firingStateTime, true, UnitLoader.colors.get("DK_BROWN"), this, parent.alphaIfHidden());
            }
        }
    }
	...
	public StrictArray<Equipment> equipment = new StrictArray<Equipment>();
...
//		return !this.weapon.isPolearm();
	...
	public float alphaIfHidden() {
		if (stage.placementPhase && isHidden) return 0.7f;
		if ( isHidden) return 0.5f;
		return 1;
	}
