...
//
//public class UnitOld extends Group {
//
...
//	public UnitOld nearestEnemy;
//	public UnitOld nearestTarget;
//
...
//
//	public UnitOld(BattleStage parent, int pos_x, int pos_y, int team, Soldier soldier, BattleParty bp) {
//		stage = parent;
//
...
//
//		this.armorTint = soldier.armorColor;
...
//		UnitOld enemy = getNearestTarget();
//		face(enemy);
...
//			if (p.orientation == thisOrientation && Math.abs(stage.heights[p.pos_y][p.pos_x] - this.getFloorHeight()) < UnitOld.CLIMB_HEIGHT) {
...
//	private boolean notAccessible(UnitOld that) {
...
//	}
//
//	private UnitOld getNearestEnemy() {
//		UnitOld closest = null;
//		UnitOld closestRetreating = null;
//		double closestDistance = 99999;
//
//		for (UnitOld that : enemyParty.units) {
...
//	private UnitOld getNearestTarget() {
//		UnitOld closest = null;
//		UnitOld closestRetreating = null;
//		UnitOld closestNormal = null; // prioritize archers
//
...
//	}
//
//	public double distanceTo(UnitOld that) {
...
//	}
//
//	public void hurt(double damage, UnitOld attacker) {
//		if (damage <= 0) return;
//
...
//		float angle = (float)Math.atan2(this.pos_x - nearestTarget.pos_x, this.pos_y - nearestTarget.pos_y) * MathUtils.radiansToDegrees;
...
//	}
//
//	public void drawAnimation(Batch batch, Animation animation, float stateTime, boolean loop) {
...
//	}
//
//	public void drawAnimationTint(Batch batch, Animation animation, float stateTime, boolean loop, Color tint) {
...
//		if (Math.abs(this.getFloorHeight() - stage.heights[pos_y][pos_x]) > UnitOld.CLIMB_HEIGHT && (!stage.ladderAt(pos_x, pos_y) || this.isMounted())) return false;
...
//	public boolean collision(UnitOld that) {
...
//	}
//
//	public void attack(UnitOld that) {
...
//	}
//
//	public boolean isAdjacent(UnitOld that) {
...
//	public void faceAlt(UnitOld that) {
