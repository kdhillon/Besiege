...
import kyle.game.besiege.location.*;
...
//	public Color currentColor; // (currentDarkness, currentDarkness, currentDarkness, 1); // Instead, see updateColor()
...
//	public void updateCurrentColor()
	...
	public void updateColor(Batch batch) {
...
//		}
	...
	public void draw(Batch batch, float parentAlpha) {
		...
		// This updates the batch color according to darkness
	...
	public static void drawTorchlightUnder(Kingdom kingdom, Army army, Batch batch, float alpha) {
...
//		System.out.println("setting paused: " + paused);
	...
	//	public void setToNight(Batch b) {
	//		b.setColor(NIGHT_FLOAT, NIGHT_FLOAT, NIGHT_FLOAT, 1f);
	//	}
	//	public void setToDay(Batch b) {
