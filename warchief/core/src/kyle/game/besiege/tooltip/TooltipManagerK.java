 ...
 * @author Nathan Sweet */
public class TooltipManagerK {
    static private TooltipManagerK instance;
    ...
    protected void showAction (Tooltip tooltip) {
        ...
        tooltip.container.addAction(parallel(fadeIn(0, fade), scaleTo(1, 1, 0.15f, Interpolation.fade)));
    }
    ...
    protected void hideAction (Tooltip tooltip) {
        tooltip.container
                .addAction(sequence(parallel(scaleTo(0.05f, 0.05f, 0.0f, Interpolation.fade)), removeActor()));
    }
    ...
    static public TooltipManagerK getInstance () {
        if (files == null || files != Gdx.files) {
            files = Gdx.files;
            instance = new TooltipManagerK();
        }
        return instance;
    }
}
