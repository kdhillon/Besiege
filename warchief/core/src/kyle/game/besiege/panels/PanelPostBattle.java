...
public class PanelPostBattle extends Panel {
    ...
    private StrictArray<SoldierTable> soldierTables = new StrictArray<SoldierTable>();
...
//        table.update("empty", "");
        ...
        SoldierTable soldierTable = new SoldierTable(this, null, true, battleStage, consolidatedKWounded, consolidatedKilled, null);
