...
//	private static final Color backgroundGrass = new Color(0x000000ff);
	...
	private Viewport kingdomViewport;
	private Viewport battleViewport;
	...
	public MapScreen(boolean generate, String name) {
		...
		kryo.register(Array.ArrayIterable.class, new Serializer<Array.ArrayIterable>() {
			...
			@Override
			public Array.ArrayIterable read(Kryo kryo, com.esotericsoftware.kryo.io.Input input, Class<? extends Array
					.ArrayIterable> type) {
				return null;
			}
		});
...
//			this.currentCamera = kingdomCamera;
	...
	public void render(float delta) {			
		...
		if (battle != null) battle.updateDarkness(currentStage.getBatch());
		else if (kingdom != null) kingdom.updateColor(currentStage.getBatch());
		...
		if (battleCamera != null) battleCamera.update();
	}
