...
//	Color[] colorsUsed;
	...
	public RandomCrestGenerator() {
        ...
        cultureToCrests.put("Tundra", new StrictArray<String>(forestCrests));
        cultureToCrests.put("Forest", new StrictArray<String>(forestCrests));
        cultureToCrests.put("Desert", new StrictArray<String>(mesoCrests));
		cultureToCrests.put("Jungle", new StrictArray<String>(mesoCrests));
        cultureToCrests.put("Plains", new StrictArray<String>(plainsCrests));
