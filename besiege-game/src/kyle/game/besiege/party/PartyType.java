...
//	CITY_GARR_1(new Weapon[]{SPEAR, PIKE, HALBERD, LONGSWORD}, new int[]{1, 1, 1, 1}, new int[]{20, 20, 20, 20}, 0, 0),
	...
	MACE_TEST2(new Weapon[]{LONGBOW, CAVALRY_SPEAR, SHORTSWORD}, new int[]{100, 20, 50}, new int[]{0, 0, 0}, 0, 0),
	MACE_TEST(new Weapon[]{ADV_LONGBOW, CAVALRY_SPEAR, GUISARME}, new int[]{100, 0, 0}, new int[]{0, 0, 0}, 0, 0);
