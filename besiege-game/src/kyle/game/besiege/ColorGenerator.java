  ...
  private static class Points {
    ...
    public List<Color> asList() {
      ...
      for (int i = 0; i < pointsCount; i++) {
        ...
        System.out.println("asList " + rgb[0] + ", " + rgb[1] + ", " + rgb[2]);
        
        Color color = new Color((float) rgb[0],
        		(float) rgb[1], (float)rgb[2], 1);
        
//        Color color = new Color(getPastelColorPercentage(rgb[0]),
//            getPastelColorPercentage(rgb[1]), getPastelColorPercentage(rgb[2]), 1);
        colors.add(color);
      }
