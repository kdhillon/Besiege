...
public enum Weapon {
	...
	// Tier 4 Ranged
	SHORTBOW (4, "Dagger", "Archer", 1, 0, 0, true, false),

	// Tier 6 Mounted (Best total = 4)
	CAVALRY_SPEAR (6, "Cavalry Spear", "Horseman", 3, 0, 1, false, false),
	CAVALRY_AXE (6, "Cavalry Axe", "Horseman", 2, 0, 2, true, false),
	CAVALRY_PICK (6, "Cavalry Pick", "Horseman", 3, -1, 2, true, false),
	...
	// Tier 6 Ranged
	CROSSBOW (6, "Dagger", "Crossbowman", 1, 0, 0, true, false), // slower, less range, more accurate, more power
	RECURVE (6, "Dagger", "Bowman", 1, 0, 0, true, false),  // faster, medium range, less accurate, medium power
	LONGBOW (6, "Dagger", "Longbowman", 1, 0, 0, true, false), // slower, more range, medium accurate, medium power
	...
	// Tier 8 Ranged
	ADV_CROSSBOW (8, "Shortsword", "Crossbow Master", 2, 1, 0, true, false), // slower, less range, more accurate, more power
	ADV_RECURVE  (8, "Shortsword", "Bowmaster",    2, 1, 0, true, false),  // faster, medium range, less accurate, medium power
	ADV_LONGBOW  (8, "Shortsword", "Longbow Master",  2, 1, 0, true, false);  // slower, more range, medium accurate, medium power
